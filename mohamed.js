...
Through this website, MAXIM emphasizes its commitment to sustainable growth and long-term enterprise value, relying on a deep understanding of industry fundamentals, demographic trends, and consumer behavior.
        ...
        modalTitle.innerText = "peaky24";
        modalImages.innerHTML = `
            <img src="images/projects/peaky/1.png" alt="Image 1">
            <img src="images/projects/peaky/2.png" alt="Image 2">
            <img src="images/projects/peaky/3.png" alt="Image 3">
            <img src="images/projects/peaky/4.png" alt="Image 4">
            <img src="images/projects/peaky/5.png" alt="Image 5">
            <img src="images/projects/peaky/6.png" alt="Image 6">
        `;
        modalDescription.innerHTML = `
Peaky24 is a custom-built eCommerce platform that I developed to provide users with a unique, seamless shopping experience. Every detail, from the smooth user interface to the visually appealing and user-friendly product displays, was crafted with care. Peaky offers a variety of T-shirts with innovative designs and high-quality fabrics, ensuring a standout experience for users from their very first visit.
            <br><br>
            <a href="https://peaky24.free.nf" target="_blank" class="view-website">View Website</a>
        `;
    }
